...
export const PRODUCTS: readonly Product[] = [
  ...
  },
  {
    ...
    description:
      "Plataformas ligadas a APIs de corretoras — incluindo a Deriv — com gráficos em tempo real e automação de estratégias. Escolha a complexidade da integração; projetos acima do topo da faixa seguem sempre por orçamento à medida.",
    priceRange: { min: 30000, max: 600000 },
    billing: "one-time",
    deliveryDays: 60,
    features: [
      ...
      groups: [
        {
          ...
          type: "single",
          options: [
            { id: "uma", label: "1 corretora (ex.: Deriv)", priceDelta: 0 },
            { id: "multiplas", label: "Múltiplas corretoras", priceDelta: 100000 },
          ],
        },
        {
          id: "automacao",
          title: "Automação de estratégias",
          type: "single",
          options: [
            { id: "nenhuma", label: "Sem automação (apenas visualização)", priceDelta: 0 },
            { id: "basica", label: "Automação básica (regras simples)", priceDelta: 80000 },
            { id: "avancada", label: "Motor de estratégias avançado", priceDelta: 200000 },
          ],
        },
        {
          id: "extras",
          ...
          type: "multi",
          options: [
            { id: "risco", label: "Gestão de risco e limites por conta", priceDelta: 40000 },
            { id: "auditoria", label: "Auditoria e registo de operações", priceDelta: 30000 },
            { id: "alertas", label: "Alertas em tempo real (push/SMS)", priceDelta: 35000 },
            { id: "multiutilizador", label: "Painel multi-utilizador com permissões", priceDelta: 60000 },
            { id: "backtesting", label: "Backtesting histórico", priceDelta: 70000 },
            { id: "expresso", label: "Prazo expresso", priceDelta: 35000 },
          ],
        },
      ],
    },
  ...
  {
    id: "web-trading-manutencao",
    slug: "manutencao-plataforma-financeira",
    name: "Manutenção Mensal — Plataforma Financeira",
    pillar: "desenvolvimento-web",
    summary: "Monitorização, atualizações e suporte contínuo da plataforma.",
    description:
      "Plano de manutenção mensal para a plataforma de negociação: monitorização de uptime, atualizações de segurança e suporte prioritário.",
    ...
    configurator: {
      ...
      levels: [
        {
          label: "Básico",
          description: "Monitorização e atualizações de segurança.",
          price: 5000,
        },
        {
          label: "Avançado",
          description: "Básico + suporte prioritário e relatório mensal de desempenho.",
          price: 8000,
        },
      ],
    },
  ...
  },
  {
    ...
    description:
      "Pacote mensal de produção assistida por IA, sempre revisto por editor humano antes de publicar. Escolha o volume mensal e os extras.",
    priceRange: { min: 2500, max: 25000 },
    billing: "monthly",
    deliveryDays: 5,
    features: [
      "Sempre revisto por editor humano",
      ...
      groups: [
        {
          ...
          type: "single",
          options: [
            { id: "4-artigos", label: "4 artigos/mês", priceDelta: 0 },
            { id: "8-artigos", label: "8 artigos/mês", priceDelta: 5000 },
            { id: "16-artigos", label: "16 artigos/mês", priceDelta: 10000 },
            { id: "30-artigos", label: "30 artigos/mês (produção diária)", priceDelta: 15000 },
          ],
        },
        {
          id: "extras",
          ...
          type: "multi",
          options: [
            { id: "legendas", label: "Legendas para redes sociais", priceDelta: 1500 },
            { id: "descricoes", label: "Descrições de produto (até 50)", priceDelta: 1500 },
            { id: "revisao", label: "Revisão editorial premium", priceDelta: 1500 },
            { id: "idiomas", label: "Idiomas adicionais (PT-BR, EN)", priceDelta: 1500 },
            { id: "voz-marca", label: "Guia de voz de marca personalizado", priceDelta: 1500 },
          ],
        },
      ],
    },
